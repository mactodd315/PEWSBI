...
sample --verbose \
    --neural-net gw150914_neural_net_withcoa.pickle \
    --sample-parameters 'total_mass' 'distance' 'coa_phase'\
    --output-file samples_sbi_withcoa.hdf \
    ...
    --write-pycbc-posterior samples_pycbc_withcoa.hdf
