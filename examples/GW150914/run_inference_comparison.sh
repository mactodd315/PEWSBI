...
#     --fake-strain-flow 10 \
#     --sample-rate 2048 \
#     --gps-start-time 1126259442 \
#     --gps-end-time 1126259482 \
#     --channel-name H1:SIMULATED_STRAIN \
#     --injection-file gw150914_injection.hdf \
#     --output-strain-file H-H1_SIMULATED_STRAIN-1126259442-40.gwf
...
#     --channel-name H1:SIMULATED_STRAIN \
#     --injection-file gw150914_injection.hdf \
#     --output-strain-file H-H1_SIMULATED_STRAIN-1126259442-40.hdf
...
sample \
    ...
    --observation-file  H1:SIMULATED_STRAIN-1126259456-16.hdf \
